...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Enseignant',
            fields=[
                ('matricule_en', models.CharField(max_length=20, primary_key=True, serialize=False)),
                ...
                ('mot_de_passe_ensei', models.CharField(blank=True, max_length=255, null=True)),
            ],
            options={
                'db_table': 'enseignant',
                'managed': False,
        ...
        migrations.CreateModel(
            name='ProfilEns',
            fields=[
                ('id_pr_en', models.AutoField(primary_key=True, serialize=False)),
            ],
            options={
                'db_table': 'profil_ens',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mgp', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
            ],
            options={
                'db_table': 'profil_etu',
                'managed': False,
