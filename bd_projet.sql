...
20u2855	sorelle	tchami	sorelle.tchami@facsciences-uy1.cm	h	pbkdf2_sha256$600000$GIZ49HqIq9grq6VcMTiPLP$xWm3sKC7LL4y9GHLI+hWsz0f/T9AugLzVctEQ256Ypk=	INFO	l3	pas_délégue
\.
...
11r29401	tchami	sorelle	nicheubertabt.facsciences-uy1@gmail.cm	h	pbkdf2_sha256$600000$Ngfavoc0z8KuxUCRlmSQyn$GH+0QEwvh203GfaIxoHoJlZ5u5BbT5OywDAaZ6TESeg=
\.
...
COPY public."ent_infoConnect_resetlink" (id, user_type, token, expiration_time) FROM stdin;
\.
...
SELECT pg_catalog.setval('public."ent_infoConnect_resetlink_id_seq"', 1, false);
